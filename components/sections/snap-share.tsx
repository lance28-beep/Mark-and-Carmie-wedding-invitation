  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-6xl mx-auto px-3 sm:px-6 md:px-8">
        ...
        >
          <div className="inline-flex items-center gap-1.5 rounded-full border border-white/40 bg-white/10 px-3 py-1.5 text-[10px] sm:text-xs tracking-[0.3em] uppercase text-white">
            Share Your Memories
          </div>
          <h2
        ...
        <motion.div className="grid grid-cols-1 lg:grid-cols-2 gap-3 sm:gap-6 lg:gap-10" variants={staggerChildren} initial="initial" animate="animate">
          ...
          >
            <div className="bg-[#BA94C3]/90 rounded-xl sm:rounded-[22px] p-3 sm:p-5 md:p-8 shadow-xl h-full flex flex-col justify-start border border-white/30">
              <div className="flex flex-col w-full">
                <h4 className={`${cinzel.className} text-base sm:text-lg md:text-xl lg:text-2xl font-semibold text-white mb-2 sm:mb-4 text-center`}>
          ...
          <motion.div className="space-y-3 sm:space-y-5 lg:space-y-6 h-full flex flex-col lg:order-2" variants={fadeInUp}>
            <div className="flex-1">
              <div className="bg-[#BA94C3]/90 rounded-xl sm:rounded-[22px] p-3 sm:p-5 md:p-8 shadow-xl text-center h-full flex flex-col border border-white/30">
                ...
                <div className="mx-auto inline-flex flex-col items-center bg-white/90 backdrop-blur-sm p-2.5 sm:p-5 md:p-7 rounded-xl sm:rounded-2xl shadow-md border border-white/30 mb-3 sm:mb-4 flex-1 justify-center">
                  <div className="mb-2 sm:mb-3 p-1.5 sm:p-3 rounded-lg sm:rounded-xl bg-white border border-white/30">
                    <div className="bg-white p-1.5 sm:p-3 rounded-lg shadow-sm border border-white/30">
                      <QRCodeCanvas 
                        id="snapshare-qr" 
                        value={websiteUrl} 
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 sm:gap-2 mx-auto px-3 sm:px-4 py-2 sm:py-2.5 rounded-lg bg-[#95B2A0] text-white border border-white/30 shadow-md hover:shadow-lg hover:-translate-y-0.5 hover:bg-[#7a9685] transition-all duration-200 text-xs sm:text-sm font-semibold"
                  >
            ...
            <div className="bg-[#BA94C3]/90 rounded-lg sm:rounded-[20px] p-3 sm:p-5 md:p-7 shadow-xl border border-white/30">
              <h5 className={`${cinzel.className} text-base sm:text-lg md:text-xl font-semibold text-white mb-2 sm:mb-3 text-center`}>
                Use Our Hashtags
              </h5>
              ...
              <div className="space-y-2.5 sm:space-y-3 mb-3 sm:mb-4">
                {hashtags.map((hashtag, index) => (
                  <motion.div
                    key={index}
                    className="bg-white/10 backdrop-blur-sm rounded-lg sm:rounded-xl p-3 sm:p-4 border border-white/30 shadow-sm hover:shadow-md transition-all duration-200"
                  ...
                  >
                    <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 sm:gap-3">
                      <span className={`${cormorant.className} text-white font-bold text-sm sm:text-base md:text-lg break-all flex-1 text-center sm:text-left`}>
                        {hashtag}
                      </span>
                      <button
                        onClick={() => copyHashtag(hashtag, index)}
                        className={`flex items-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-lg bg-[#95B2A0] text-white transition-all duration-200 shadow-md hover:shadow-lg hover:scale-105 whitespace-nowrap flex-shrink-0 hover:bg-[#7a9685] ${
              ...
              <button
                ...
                className={`w-full flex items-center justify-center gap-2 px-4 py-2.5 sm:py-3 rounded-lg bg-[#95B2A0] text-white border-2 border-white/30 transition-all duration-200 shadow-md hover:shadow-lg hover:bg-[#7a9685] hover:border-white/50 ${
            ...
            <div className="bg-[#BA94C3]/90 rounded-lg sm:rounded-[20px] p-3 sm:p-5 md:p-7 shadow-xl border border-white/30">
              ...
              <div className="grid grid-cols-2 gap-2 sm:gap-3 md:gap-4">
                <button
                  ...
                  className="group flex items-center justify-center gap-1.5 sm:gap-2 bg-white/10 border border-white/30 text-white px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg hover:bg-white/20 transition-all duration-200 shadow-md hover:shadow-lg hover:border-white/50"
                >
            ...
            {driveLink && (
              <div>
                <div className="bg-[#BA94C3]/90 rounded-xl sm:rounded-[22px] p-3 sm:p-5 md:p-7 shadow-xl text-center border border-white/30">
                  <div className="inline-flex items-center gap-1.5 sm:gap-2 rounded-full border border-white/30 bg-white/10 px-2.5 py-1 text-[10px] sm:text-xs uppercase tracking-[0.25em] sm:tracking-[0.32em] text-white mb-2 sm:mb-3">
                  ...
                  <div className="mx-auto inline-flex flex-col items-center bg-white/90 backdrop-blur-sm p-2.5 sm:p-5 rounded-xl sm:rounded-2xl shadow-md border border-white/30 mb-3 sm:mb-4">
                    <div className="mb-2 sm:mb-3 p-1.5 sm:p-3 rounded-lg sm:rounded-xl bg-white border border-white/30">
                      <div className="bg-white p-1.5 sm:p-3 rounded-lg shadow-sm border border-white/30">
                        <QRCodeCanvas id="drive-qr" value={driveLink} size={isMobile ? 130 : 200} includeMargin className="bg-white" />
                    </div>
                  </div>
                    <p className={`${cormorant.className} text-white text-xs sm:text-sm`}>📱 Scan with your camera app</p>
                  </div>
                  <div className="flex flex-col sm:flex-row justify-center gap-2 sm:gap-3">
                    <button
                      onClick={copyDriveLink}
                      className={`flex items-center justify-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 sm:py-2.5 rounded-lg bg-[#95B2A0] text-white border border-white/30 shadow-sm hover:shadow-md hover:bg-[#7a9685] text-xs sm:text-sm transition-all ${
                    ...
                    <button
                      ...
                      className="flex items-center justify-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 sm:py-2.5 rounded-lg bg-[#95B2A0] text-white border border-white/30 shadow-sm hover:shadow-md hover:bg-[#7a9685] text-xs sm:text-sm transition-all font-semibold"
                    >
                      <Download className="w-3.5 h-3.5 sm:w-4 sm:h-4" />
                      <span className={`${cormorant.className} tracking-[0.15em] sm:tracking-[0.18em] uppercase font-medium`}>Download QR</span>
                    </button>
                    <a
                      ...
                      className="flex items-center justify-center gap-1.5 sm:gap-2 px-3 sm:px-4 py-2 sm:py-2.5 rounded-lg bg-white/10 border border-white/30 text-white shadow-sm hover:shadow-md hover:bg-white/20 text-xs sm:text-sm transition-all"
                    >
        ...
        <motion.div className="text-center mt-5 sm:mt-10" variants={fadeInUp}>
          <div className="bg-[#BA94C3]/90 rounded-xl sm:rounded-[22px] p-4 sm:p-6 md:p-7 shadow-[0_25px_80px_rgba(0,0,0,0.15)] border border-white/30 max-w-3xl mx-auto backdrop-blur-xl">
